...
You can compute functional diversity indices `fd_fric()` lets you compute Functional Richness,
`fd_fdiv()` lets you compute functional divergence, and `fd_raoq()` lets you compute Rao's Quadratic Entropy:
