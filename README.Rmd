...
mFD         = pkg_has_vignettes_and_test("mFD")
```
...
| [`mFD`](https://github.com/CmlMagneville/mFD)         | Functional α- and β-diversity indices, including FRic, FDiv, FDis, FEve, FIde, FMPD, FNND, FOri, FSpe, Hill Numbers |`r mFD[[1]]`        |`r mFD[[2]]`        | ✅        | ![](https://www.r-pkg.org/badges/last-release/mFD)        |
