...
<!-- 
# Pre-render with 
knitr::knit("vignettes/_fundiversity-2-performance.Rmd", output = "vignettes/fundiversity-2-performance.Rmd")
-->
...
The other packages are thus: `adiv` [@Pavoine_adiv_2020], `BAT` [@Cardoso_BAT_2015], `betapart` [@Baselga_betapart_2012], `FD` [@Laliberte_FD_2014], `hillR` [@Li_hillR_2018], and `mFD` [@Magneville_mFD_2022].
