...
**Parallelization**. The computation of this function can be parallized thanks to the `future` package. Refer to the [parallelization vignette](./parallel.html) to get more information about how to do so.
...
|     Function Name     |   Index Name   | Parallizable^1 | Memoizable^2 |
|:---------------------:|:---------------|:--------------:|:------------:|
| `fd_fric()`           | FRic           | ✅             |  ✅         |
...
[1]: parallelization through the `future` backend please refer to the [parallelization vignette](./parallel.html) for details.
