...
bench_sp_raoq <- microbenchmark::microbenchmark(
  ...
  species_100000 = fd_raoq(null_sp_100000$tr, null_sp_100000$si),
  times = 30
)
...
bench_sp_feve <- microbenchmark::microbenchmark(
  ...
  species_100000 = fd_feve(null_sp_100000$tr, null_sp_100000$si),
  times = 30
)
...
all_bench_sp <- list(fric = bench_species_fric,
                     fdiv = bench_species_fdiv,
                     raoq = bench_species_raoq,
                     feve = bench_species_feve) %>%
...
```{r sessioninfo}
tictoc::toc(msg = "Time needed to generate this document")
